...
export default function Conversation({
  ...
  return (
    <div
      className={`flex w-full h-[95%] bg-black ${
      ...
      {chat ? (
        ...
        >
          ...
          >
            ...
            >
              <div className="flex items-center gap-4 h-full rounded-full ">
                <div className="w-10 h-10 rounded-full bg-white">
                  <Image
                    src={contact?.pic || "/nopic.svg"}
                    alt="sd"
                    width={40}
                    height={40}
          ...
          <div
            ref={convRef}
            className="flex flex-col w-full h-full px-10 py-12 overflow-y-auto bg-[#000000]"
            style={{
          ...
          <footer
            className=" fixed flex w-full items-end justify-center h-12  text-[#00000099] lg:w-[calc(100vw-480px)]"
            style={{ height: 64, bottom: 0, background: "#000" }}
          >
            <div className="flex w-full md:fixed  md:w-[60%] md:-ml-40 mb-[10px] md:right-0">
              <div className="flex w-full items-center rounded-full bg-[#535353] w-[80%] ml-2 ">
                ...
                <div className="flex py-1 pl-5  py-1  pr-2  gap-3">
                  <svg
                    viewBox="0 0 24 24"
                    width={24}
                    height={24}
              ...
              <div
                onClick={handleSend}
                className="flex justify-center items-center md:-ml-10 w-[20%] h-12"
              >
                <img
                  src="/sendBtn.png"
                  alt=""
